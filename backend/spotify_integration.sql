-- Spotify Integration Tables for DISBA Music
...
CREATE TABLE IF NOT EXISTS public.spotify_analytics (
    ...
    total_revenue NUMERIC DEFAULT 0.00,  -- Revenue dari Spotify
    disba_commission NUMERIC DEFAULT 0.00, -- 15-20% untuk DISBA
    artist_payout NUMERIC DEFAULT 0.00, -- Sisanya untuk artist
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
