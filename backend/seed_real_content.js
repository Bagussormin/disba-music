...
async function seedRealData() {
  console.log('Seeding REAL landing page content...');
  
  const djs = [
    { 
      name: 'Rangga Zenico', stage_name: 'DJ VORTEX', rank: 1, plays: '124.5k', likes: '12.4k', 
      image: 'https://hwxrxwfrpilxkpdlolph.supabase.co/storage/v1/object/public/rilisan/assets/dj_vortex_real.png', 
    ...
    { 
      name: 'Maya Adista', stage_name: 'LUNA RAY', rank: 2, plays: '98.2k', likes: '8.7k', 
    ...
    { 
      name: 'Vino Saputra', stage_name: 'NOVA PULSE', rank: 3, plays: '75.1k', likes: '6.2k', 
      image: 'https://images.unsplash.com/photo-1571266028243-e4733b0f0bb1?q=80&w=2070&auto=format&fit=crop', 
      badge: 'Crowd Fav', genre: 'Tech House', location: 'Bandung, ID',
      bio: 'Energy is the name of the game. Vino brings high-octane tech house that keeps the dancefloor moving.',
      recent_tracks: ['Summer Ghost', 'Rhythm Machine', 'Bassline Theory'],
      upcoming: 'Arena Stage - Saturday'
    },
    { 
      name: 'Aris Tama', stage_name: 'ZENITH', rank: 4, plays: '62.8k', likes: '5.1k', 
      image: 'https://images.unsplash.com/photo-1574391884720-bbc37bb01932?q=80&w=1974&auto=format&fit=crop', 
      badge: 'Top 10', genre: 'Industrial Techno', location: 'Surabaya, ID',
      bio: 'Dark, raw, and uncompromising. Aris is the sound of the industrial outskirts of Surabaya.',
  ...
  const events = [
    { 
      ...
      lineup: ['Rangga Zenico (DJ Vortex)', 'Maya Adista (Luna Ray)'],
    ...
    { 
      ...
      lineup: ['Vino Saputra (Nova Pulse)', 'Guest DJ'],
    ...
    { 
      ...
      lineup: ['Aris Tama (Zenith)', 'Vortex', 'Pulse'],
  ...
  try {
    // Truncate first to avoid duplicates or messy data
    await supabase.from('djs').delete().neq('id', 0);
    await supabase.from('events').delete().neq('id', 0);

    const { error: djError } = await supabase.from('djs').insert(djs);
    if (djError) throw djError;
    console.log('Real DJs seeded successfully.');
